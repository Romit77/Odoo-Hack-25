...
const OwnerOTPVerification = () => {
  ...
  const { ownerId, phone } = location.state || {};
  ...
  const handleVerifyOTP = async () => {
    ...
    setLoading(true);
    try {
      const response = await axiosInstance.post("/api/owner/auth/verify-otp", {
        ownerId,
        otp: otpString,
      });
  ...
  const handleResendOTP = async () => {
    ...
    try {
      const response = await axiosInstance.post("/api/owner/auth/resend-otp", {
        ownerId,
      });
